...
/*
    ...
    Cmdline:
        sokol-shdc --input sokol-rust/examples/offscreen/shader.glsl --output sokol-rust/examples/offscreen/shader.rs -f sokol_rust --slang glsl430:hlsl5:metal_macos
