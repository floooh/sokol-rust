...
pub fn dbg_shader_desc(backend: sg::Backend) -> sg::ShaderDesc {
    ...
    match backend {
        sg::Backend::Glcore => {
            ...
            desc.vs.source = &VS_DBG_SOURCE_GLSL430 as *const _ as *const _;
            desc.vs.entry = c"main".as_ptr();
            desc.fs.source = &FS_DBG_SOURCE_GLSL430 as *const _ as *const _;
        ...
        sg::Backend::D3d11 => {
            ...
            desc.vs.source = &VS_DBG_SOURCE_HLSL5 as *const _ as *const _;
            desc.vs.d3d11_target = c"vs_5_0".as_ptr();
            desc.vs.entry = c"main".as_ptr();
            desc.fs.source = &FS_DBG_SOURCE_HLSL5 as *const _ as *const _;
...
pub fn fsq_shader_desc(backend: sg::Backend) -> sg::ShaderDesc {
    ...
    match backend {
        sg::Backend::Glcore => {
            desc.attrs[0].name = c"pos".as_ptr();
            desc.vs.source = &VS_FSQ_SOURCE_GLSL430 as *const _ as *const _;
            desc.vs.entry = c"main".as_ptr();
            ...
            desc.fs.source = &FS_FSQ_SOURCE_GLSL430 as *const _ as *const _;
            desc.fs.entry = c"main".as_ptr();
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
            desc.fs.images[0].image_type = sg::ImageType::Dim2;
        ...
        sg::Backend::D3d11 => {
            desc.attrs[0].sem_name = c"TEXCOORD".as_ptr();
            desc.attrs[0].sem_index = 0;
            desc.vs.source = &VS_FSQ_SOURCE_HLSL5 as *const _ as *const _;
            desc.vs.d3d11_target = c"vs_5_0".as_ptr();
            desc.vs.entry = c"main".as_ptr();
            desc.vs.uniform_blocks[0].size = 16;
            desc.vs.uniform_blocks[0].layout = sg::UniformLayout::Std140;
            desc.fs.source = &FS_FSQ_SOURCE_HLSL5 as *const _ as *const _;
            desc.fs.d3d11_target = c"ps_5_0".as_ptr();
            desc.fs.entry = c"main".as_ptr();
            desc.fs.images[0].used = true;
            desc.fs.images[0].multisampled = false;
...
pub fn offscreen_shader_desc(backend: sg::Backend) -> sg::ShaderDesc {
    ...
    match backend {
        sg::Backend::Glcore => {
            ...
            desc.vs.source = &VS_OFFSCREEN_SOURCE_GLSL430 as *const _ as *const _;
            desc.vs.entry = c"main".as_ptr();
            ...
            desc.fs.source = &FS_OFFSCREEN_SOURCE_GLSL430 as *const _ as *const _;
            desc.fs.entry = c"main".as_ptr();
        },
        sg::Backend::D3d11 => {
            desc.attrs[0].sem_name = c"TEXCOORD".as_ptr();
            ...
            desc.vs.source = &VS_OFFSCREEN_SOURCE_HLSL5 as *const _ as *const _;
            desc.vs.d3d11_target = c"vs_5_0".as_ptr();
            desc.vs.entry = c"main".as_ptr();
            desc.vs.uniform_blocks[0].size = 64;
            desc.vs.uniform_blocks[0].layout = sg::UniformLayout::Std140;
            desc.fs.source = &FS_OFFSCREEN_SOURCE_HLSL5 as *const _ as *const _;
            desc.fs.d3d11_target = c"ps_5_0".as_ptr();
            desc.fs.entry = c"main".as_ptr();
        },
        sg::Backend::MetalMacos => {
