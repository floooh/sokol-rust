...
/*
    ...
    Cmdline:
        sokol-shdc -i examples/triangle/shader.glsl -o examples/triangle/shader.rs -l glsl430:metal_macos:hlsl5 -f sokol_rust
    ...
    Bindings:
*/
pub const ATTR_TRIANGLE_POSITION: usize = 0;
pub const ATTR_TRIANGLE_COLOR0: usize = 1;
/*
    #version 430
...
pub fn triangle_shader_desc(backend: sg::Backend) -> sg::ShaderDesc {
    let mut desc = sg::ShaderDesc::new();
    desc.label = c"triangle_shader".as_ptr();
    match backend {
        sg::Backend::Glcore => {
