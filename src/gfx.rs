...
pub enum LogItem {
    ...
    ValidateDrawWriteBufferTransientMissing,
    ValidateDrawWriteImageTransientMissing,
...
impl WgpuDesc {
    pub const fn new() -> Self {
        Self { disable_bindgroups_cache: false, bindgroups_cache_size: 0 }
    }
}
