...
pub fn d3d11_get_render_view() -> *const core::ffi::c_void {
    unsafe {
        ffi::sapp_d3d11_get_render_view()
    }
}
#[inline]
pub fn d3d11_get_resolve_view() -> *const core::ffi::c_void {
    unsafe {
        ffi::sapp_d3d11_get_resolve_view()
    }
}
#[inline]
